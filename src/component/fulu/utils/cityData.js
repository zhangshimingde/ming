...
export const cityData = {
  "北京市": ["昌平区", "朝阳区", "大兴区", "东城区", "房山区", "丰台区", "海淀区", "怀柔区", "门头沟区", "密云区", "平谷区", "石景山区", "顺义区", "通州区", "西城区", "延庆区", "其它"],
  "天津市": ["宝坻区", "北辰区", "滨海新区", "东丽区", "河北区", "河东区", "和平区", "河西区", "红桥区", "蓟州区", "津南区", "静海区", "南开区", "宁河区", "武清区", "西青区", "其它"],
  "上海市": ["宝山区", "长宁区", "崇明区", "奉贤区", "虹口区", "黄浦区", "嘉定区", "金山区", "静安区", "闵行区", "浦东新区", "普陀区", "青浦区", "松江区", "徐汇区", "杨浦区", "其它"],
  "重庆市": ["巴南区", "北碚区", "璧山区", "长寿区", "大渡口区", "大足区", "涪陵区", "合川区", "江北区", "江津区", "九龙坡区", "开州区", "梁平区", "南岸区", "南川区", "綦江区", "黔江区", "荣昌区", "沙坪坝区", "铜梁区", "潼南区", "万州区", "武隆区", "永川区", "渝北区", "渝中区", "城口县", "垫江县", "丰都县", "奉节县", "巫山县", "巫溪县", "云阳县", "忠县", "彭水苗族土家族自治县", "石柱土家族自治县", "秀山土家族苗族自治县", "酉阳土家族苗族自治县", "其它"],
  ...
  "新疆维吾尔自治区": ['乌鲁木齐市', '克拉玛依市', '石河子市　', '阿拉尔市', '图木舒克市', '五家渠市', '吐鲁番市', '阿克苏市', '喀什市', '哈密市', '和田市', '阿图什市', '库尔勒市', '昌吉市　', '阜康市', '米泉市', '博乐市', '伊宁市', '奎屯市', '塔城市', '乌苏市', '阿勒泰市'],
